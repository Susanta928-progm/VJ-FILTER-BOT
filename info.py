...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '1002409777231')).split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ToonAnimeSreq')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AnimeChillax_Community' )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/SST_ANIME_GROUP.') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/BORNHYPER_ACX')
